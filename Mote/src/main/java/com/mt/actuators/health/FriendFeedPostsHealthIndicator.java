...
/**
 * The <code>FriendFeedPostsHealthIndicator</code> class is a custom health check indicator.
 * 
 * @author gibranecastillo
 *
 */
@Component
public class FriendFeedPostsHealthIndicator implements HealthIndicator {
	@Autowired
	...
	public Health health() {
		List<Post> posts = postDao.getFriendFeedPosts();
