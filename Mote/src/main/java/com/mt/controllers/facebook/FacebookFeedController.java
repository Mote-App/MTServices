...
/**
 * The <code>FacebookFeedController</code> is created by injecting a Facebook object into its constructor.
 * The Facebook object is a reference to Spring Social’s Facebook API binding.
 * 
 * @Controller marks the FacebookFeedController.java POJO class as MVC controller
 * 
...
public class FacebookFeedController {
	...
	public String showFeed(ModelMap model) {
		...
		model.addAttribute("friendFeed", feed);
