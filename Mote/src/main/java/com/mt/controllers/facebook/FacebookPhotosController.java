...
/**
 * The <code>FacebookPhotosController</code> is created by injecting a Facebook object into its constructor.
 * The Facebook object is a reference to Spring Social’s Facebook API binding.
 * 
 * @Controller marks the FacebookPhotosController.java POJO class as MVC controller
 * 
...
public class FacebookPhotosController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/facebook_photos/aggregation", method=RequestMethod.GET)
	@ResponseBody
	public String facebookPhotosAggregation(ModelMap model) {
		/*
	 ...
	 * @return
	 */
	@RequestMapping(value="/facebook_photo/albums", method=RequestMethod.GET)
	public String showPhotoAlbums(ModelMap model) {
		if(!facebook.isAuthorized()) {
			return "redirect:/connect/facebook";
		}
