...
/**
 * The <code>TwitterSearchController</code> is created by injecting a Twitter object into its constructor.
 * The Twitter object is a reference to Spring Social’s Twitter API binding.
 * 
 * @Controller marks the TwitterSearchController.java POJO class as MVC controller
 * 
...
public class TwitterSearchController {
	 ...
	 * This method ...
	 * 
	 * @RequestParam maps HTTP request parameter with name to the method parameter
	 * 
	 * @param query
	 * @param model
	 * @return
	...
	public String showTrends(@RequestParam("query") String query, ModelMap model) {
		if(connectionRepository.findPrimaryConnection(Twitter.class) == null) {
            return "redirect:/connect/twitter";
        }
