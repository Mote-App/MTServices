...
/**
 * The <code>TwitterTimelineController</code> is created by injecting a Twitter object into its constructor.
 * The Twitter object is a reference to Spring Social’s Twitter API binding.
 * 
 * @Controller marks the TwitterTimelineController.java POJO class as MVC controller
 * 
...
public class TwitterTimelineController {
	...
	@Inject
	public TwitterTimelineController(Twitter twitter, ConnectionRepository connectionRepository) {
	...
	public String showTimeline(ModelMap model) {
	...
	public String showTimeline(@PathVariable("timelineType") String timelineType, ModelMap model) {
		if(connectionRepository.findPrimaryConnection(Twitter.class) == null) {
            return "redirect:/connect/twitter";
        }
