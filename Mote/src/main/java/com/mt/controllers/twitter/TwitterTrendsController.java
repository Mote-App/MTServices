...
/**
 * The <code>TwitterTrendsController</code> is created by injecting a Twitter object into its constructor.
 * The Twitter object is a reference to Spring Social’s Twitter API binding.
 * 
 * @Controller marks the TwitterTrendsController.java POJO class as MVC controller
 * 
...
public class TwitterTrendsController {
	...
	@Inject
	public TwitterTrendsController(Twitter twitter, ConnectionRepository connectionRepository) {
	...
	public String showTrends(ModelMap model) {
		if(connectionRepository.findPrimaryConnection(Twitter.class) == null) {
            return "redirect:/connect/twitter";
        }
